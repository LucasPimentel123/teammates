...
public class FeedbackResponseCommentsLogicTest extends BaseLogicTest {
        ...
        public void testCreateFeedbackResponseComment() throws Exception {
                FeedbackResponseCommentAttributes frComment = restoreFrCommentFromDataBundle(
                ...
                ednee = assertThrows(EntityDoesNotExistException.class,
                                () -> frcLogic.createFeedbackResponseComment(finalFrc[0]));
                assertEquals(
                                "Feedback session " + frComment.getFeedbackSessionName()
                ...
                frComment.setFeedbackResponseId(
                                getResponseIdInDataBundle("response2ForQ1S1C1", "qn1InSession1InCourse1"));
        ...
        public void testGetFeedbackResponseComments() {
                ...
                List<FeedbackResponseCommentAttributes> actualFrComments = frcLogic
                ...
                actualFrComment = frcLogic.getFeedbackResponseComment(
                                frComment.getFeedbackResponseId(), frComment.getCommentGiver(),
                                frComment.getCreatedAt());
                ...
                FeedbackResponseCommentAttributes tempFrComment = restoreFrCommentFromDataBundle(
                                "comment1FromT1C1ToR1Q1S1C1");
                ...
                for (int i = 0; i < expectedFrComments.size(); i++) {
                        ...
                        assertEquals(expectedFrComments.get(i).getCommentGiver(),
                                        actualFrComments.get(i).getCommentGiver());
        ...
        public void testDeleteFeedbackResponseComment() {
                FeedbackResponseCommentAttributes frComment = restoreFrCommentFromDataBundle(
                                "comment1FromT1C1ToR1Q1S1C1");
                FeedbackResponseCommentAttributes actualFrComment = frcLogic
                                .getFeedbackResponseCommentForSessionInSection(
                                                frComment.getCourseId(), frComment.getFeedbackSessionName(), null)
                                .get(1);
        ...
        public void testDeleteFeedbackResponseComments_deleteByCourseId() {
                ...
                List<FeedbackResponseCommentAttributes> frcList = frcLogic
                                .getFeedbackResponseCommentForSessionInSection(courseId, "First feedback session",
                                                null);
        ...
        public void testGetFeedbackResponseCommentForSessionInSection_noSectionName_shouldReturnCommentsInSession() {
                List<FeedbackResponseCommentAttributes> comments = frcLogic
                                .getFeedbackResponseCommentForSessionInSection(
        ...
        public void testGetFeedbackResponseCommentsForQuestionInSection_noSectionName_shouldReturnCommentsForQuestion() {
                ...
                List<FeedbackResponseCommentAttributes> comments = frcLogic
                                .getFeedbackResponseCommentForQuestionInSection(questionId, null);
                assertEquals(1, comments.size());
        ...
        public void testGetFeedbackResponseCommentsForQuestionInSection_withSectionName_shouldReturnCommentsForQuestion() {
                ...
                List<FeedbackResponseCommentAttributes> comments = frcLogic
                                .getFeedbackResponseCommentForQuestionInSection(questionId, "Section 1");
                assertEquals(1, comments.size());
        ...
        public void testIsNameVisibleToUser() {
                ...
                FeedbackResponseCommentAttributes comment = dataBundle.feedbackResponseComments
                ...
                CourseRoster rosterWithStudentListByEmailEmpty = new CourseRoster(null,
                                new ArrayList<>(courseRosterDataBundle.instructors.values()));
                ...
                assertTrue(frcLogic.isNameVisibleToUser(comment, relatedResponse, instructor3InUnknownCourseEmail,
                                roster));

                // test user's participant type is in the list that comment giver's name is
                // shown to
                ...
                comment.setShowGiverNameTo(Arrays.asList(INSTRUCTORS));
                assertTrue(frcLogic.isNameVisibleToUser(comment, relatedResponse, instructor2InCourse1Email,
                                rosterWithStudentListByEmailEmpty));
        ...
        public void testIsResponseCommentVisibleForUser() {
                ...
                List<StudentAttributes> studentsInTeam = roster.getTeamToMembersTable().getOrDefault(student.getTeam(),
                ...
                FeedbackResponseCommentAttributes commentVisibleToNoOneExceptSelf = FeedbackResponseCommentAttributes
                                .builder()
                                .withCommentGiver("student4InCourse1@gmail.tmt")
                                .withCommentGiverType(STUDENTS)
                                .withVisibilityFollowingFeedbackQuestion(false)
                ...
                assertTrue(frcLogic.isResponseCommentVisibleForUser("student4InCourse1@gmail.tmt", false,
                                ...
                                commentVisibleToNoOneExceptSelf));
                ...
                FeedbackResponseCommentAttributes commentVisibleToTeamMembersInstructor = FeedbackResponseCommentAttributes
                                .builder()
                                .withCommentGiver("student4InCourse1@gmail.tmt")
                ...
                assertTrue(frcLogic.isResponseCommentVisibleForUser("student1InCourse1@gmail.tmt", false,
                                student, studentsEmailInTeam, response, relatedQuestion,
                                commentVisibleToTeamMembersInstructor));
                ...
                studentsInTeam = roster.getTeamToMembersTable().getOrDefault(student.getTeam(),
                                Collections.emptyList());
                ...
                FeedbackResponseCommentAttributes commentVisibleToResponseReceiver = FeedbackResponseCommentAttributes
                                .builder()
                                .withCommentGiver("student4InCourse1@gmail.tmt")
                ...
                assertTrue(frcLogic.isResponseCommentVisibleForUser("student1InCourse1@gmail.tmt", false,
                                student, studentsEmailInTeam, response, relatedQuestion,
                                commentVisibleToResponseReceiver));
                ...
                FeedbackResponseCommentAttributes commentVisibleToResponseGiver = FeedbackResponseCommentAttributes
                                .builder()
                                .withCommentGiver("student4InCourse1@gmail.tmt")
                                .withCommentGiverType(GIVER)
                                .withVisibilityFollowingFeedbackQuestion(false)
                ...
                response = dataBundle.feedbackResponses.get("response2ForQ2S1C1");
                response.setRecipient("student1InCourse1@gmail.tmt");
                FeedbackResponseCommentAttributes commentVisibleToResponseReceiverTeamMember = FeedbackResponseCommentAttributes
                                .builder()
                ...
                FeedbackResponseCommentAttributes commentVisibilityFollowsQuestion = FeedbackResponseCommentAttributes
                                .builder()
                                .withCommentGiver("student4InCourse1@gmail.tmt")
                                .withCommentGiverType(OWN_TEAM_MEMBERS)
                ...
                assertTrue(frcLogic.isResponseCommentVisibleForUser("student1InCourse1@gmail.tmt", false,
                                student, studentsEmailInTeam, response, relatedQuestion,
                                commentVisibilityFollowsQuestion));
        ...
        private void verifyNullFromGetFrCommentForSession(FeedbackResponseCommentAttributes frComment) {
                List<FeedbackResponseCommentAttributes> frCommentsGot = frcLogic
                                .getFeedbackResponseCommentForSessionInSection(
                                                frComment.getCourseId(), frComment.getFeedbackSessionName(), null);
        ...
        private void verifyNullFromGetFrComment(FeedbackResponseCommentAttributes frComment) {
                FeedbackResponseCommentAttributes frCommentGot = frcLogic.getFeedbackResponseComment(
                                frComment.getFeedbackResponseId(), frComment.getCommentGiver(),
                                frComment.getCreatedAt());
        ...
        private FeedbackResponseCommentAttributes restoreFrCommentFromDataBundle(String existingFrCommentInDataBundle) {
                ...
                FeedbackResponseCommentAttributes existingFrComment = dataBundle.feedbackResponseComments
                                .get(existingFrCommentInDataBundle);
        ...
        private void restoreFrCommentIdFromExistingOne(
                ...
                List<FeedbackResponseCommentAttributes> existingFrComments = frcLogic
                                .getFeedbackResponseCommentForSessionInSection(
